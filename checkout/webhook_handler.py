...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        grand_total = rounded(intent.data.charges[0].amount/ 100, 2)
        ...
        try:
            order = Order.objects.get(
                ...
                street_address1__iexact=shipping_details.line2,
                street_address2__iexact=shipping_details.line1,
            ...
            try:
                order = Order.objects.create(
                    ...
                    street_address1=shipping_details.line2,
                    street_address2=shipping_details.line1,
